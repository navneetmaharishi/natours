...
exports.signup = catchAsync(async (req, res, next) => {
  // const newUser = await User.create(req.body); // By using this anyone can add anything WRONG APPROACH
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  let token;
  console.log("req.cookies.jwt protect===>", req.cookies.jwt);
  if (
...
exports.isLoggedIn = catchAsync(async (req, res, next) => {
  console.log("\n req.cookies.jwt isLoggedIn===>", req.cookies.jwt,'\n');
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  const message = `Forgot your password? Submit a PATCH request with your new password and passwordConfirm to: ${resetURL}.\n If you dont forgot your email then please ignore this email.`;
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  if (!isPassCorrect)
    return next(new AppError("Please enter corretct password", 400));
