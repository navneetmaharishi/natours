...
var login = function login(email, password) {
  _axios.default.post("http://127.0.0.1:3000/api/v1/users/login", {
    email: email,
    password: password
  }).then(function (res) {
...
var logout = function logout() {
  _axios.default.get("http://127.0.0.1:3000/api/v1/users/logout").then(function (res) {
    if (res.data.status === "success") {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _axios.default.patch(url, data).then(function (res) {
              if (res.data.status === "success") {
...
// DOM element
var submitButton = document.querySelector(".form--login");
var logoutButton = document.querySelector(".nav__el--logout");
var userDataForm = document.querySelector(".form-user-data");
var userPasswordForm = document.querySelector(".form-user-password");
submitButton && submitButton.addEventListener("submit", function (e) {
  e.preventDefault();
  var email = document.getElementById("email").value,
      password = document.getElementById("password").value;
  (0, _login.login)(email, password);
});
logoutButton && logoutButton.addEventListener("click", _login.logout);
userDataForm && userDataForm.addEventListener("submit", function (e) {
  e.preventDefault();
...
userPasswordForm && userPasswordForm.addEventListener("submit", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            currentPassword = document.getElementById("password-current").value, password = document.getElementById("password").value, passwordConfirm = document.getElementById("password-confirm").value;
            _context.next = 5;
